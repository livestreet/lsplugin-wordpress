...
{elseif $sEvent=='edit'}
	...
	{include file="$sTemplatePathPlugin/actions/ActionContent/add.tpl"}
{else}
	<a href="{router page='contentany'}add/">{$aLang.wordpress_content_action_add}</a>
{/if}
...
<table width="100%" cellspacing="0">
  	<tr>
    	<th align="center" width="30px">{$aLang.wordpress_content_field_id}</th>
    	<th align="left" width="200px">{$aLang.wordpress_content_field_name}</th>    	
    	<th align="left">{$aLang.wordpress_content_field_title}</th>
    	<th align="center" width="50px">{$aLang.wordpress_content_field_php}</th>    	   	
    	<th align="center" width="60px">{$aLang.wordpress_content_action}</th>    	   	
  	</tr>
